...
//metody
    ...
    // ulozeni vysledku do
    $result1 = mysqli_query($this->SRBD, self::dotazTrans) or Die(mysqli_error($this->SRBD));

    $result2 = mysqli_query($this->SRBD, self::dotazAmount) or Die(mysqli_error($this->SRBD));
